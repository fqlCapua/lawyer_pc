...
function showDjModal(){
	...
	$('#myDJ').modal('show');
	//get_newCase_id();
	//setTimeout("if(1){}else{layer.msg('请刷新页面')}",1500);
...
new Vue({
 ...
 data:{
 	  user:{
 		...
 		case_title:"",
 		case_record:"",
 		case_user_id:'410329199310126666',
 		user_lid:"", //岗位级别ID
   		user_did:"", //所属部门id
   		case_sid:"", //案源id
...
// 		case_sid:$('#case_sid').children('option:selected').attr('name'), //案源id
